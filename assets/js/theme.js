...
// Update theme from "dark" or "light" or "system" to "dark" or "light".
let updateThemeSetting = (themeSetting) => {
...
let determineComputedTheme = () => {
  ...
  themeSetting = updateThemeSetting(themeSetting);
  return themeSetting;
};

// Toggle through light, dark theme settings.
